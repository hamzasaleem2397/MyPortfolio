...
const greeting = {
  ...
  subTitle:
    "React Native and React Developer, Open Source Enthusiast 🔥. Always learning.",
  resumeLink:
  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Developing crossflatfom mobile applications using ReactNative",
  ...
  degrees: [
    {
      ...
      website_link: "https://www.bahria.edu.pk/bukc/",
    },
  ],
};
...
const certifications = {
  certifications: [
    {
      title: "Introducation to Game Developement",
      subtitle: "Michigan Univeristy",
      logo_path: "mongo.png",
      certificate_link:
